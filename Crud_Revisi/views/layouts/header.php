...
<style>
    ...
    .table thead { background-color: #f1f5f9; color: #64748b; text-transform: uppercase; font-size: 0.85rem; letter-spacing: 0.05em; }
    .table td { vertical-align: middle; border-bottom: 1px solid #e2e8f0; }
</style>
<body>
