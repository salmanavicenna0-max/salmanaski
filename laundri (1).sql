...
--
-- Host: localhost
-- Waktu pembuatan: 05 Bulan Mei 2026 pada 10.13
...
(1, 2, 'INV-20260505-001', 1, '2026-05-05 10:10:56', '2026-05-13 23:59:59', '2026-05-05 10:11:11', 9000, 200, 2000, 'selesai', 'dibayar', 1);
...
(12, 'salmon', 'salmon', '223', 101, 'owner'),
...
ALTER TABLE `tb_detail_transaksi`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `id_transaksi` (`id_transaksi`,`id_paket`);
